...
import m.com.atomy.activity.MainActivity
import m.com.atomy.activity.PushPopupActivity
import m.com.atomy.fcm.PushPreferences.PUSH_DATA
import m.com.atomy.notification.PushNotification
import m.com.atomy.utils.DLog
import m.com.atomy.utils.isAppRunning
import m.com.atomy.utils.isForeground
...
class FcmListenerService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        if (m.com.atomy.MyApplication.instance != null) {
            DLog.v("bjj FcmListenerService push isChating : " + m.com.atomy.MyApplication.instance.isChating)

            if (m.com.atomy.MyApplication.instance.isChating) {
                return
            }
        }
