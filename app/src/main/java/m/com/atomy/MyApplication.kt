...
class MyApplication : Application() {
    companion object {
        lateinit var instance: m.com.atomy.MyApplication
            private set
...
//                Manifest.permission.WRITE_EXTERNAL_STORAGE
    ...
    override fun onCreate() {
        super.onCreate()
        m.com.atomy.MyApplication.Companion.instance = this
    ...
    private fun makeNotiChannel() {
        ...
        val name2 = getString(m.com.atomy.R.string.noti_channel_name_push)
