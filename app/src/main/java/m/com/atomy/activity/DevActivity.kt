...
import m.com.atomy.utils.SharedPreferencesUtil
...
class DevActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun initURL() {
        urlList.add(m.com.atomy.activity.DevActivity.Companion.DEV_SETTING_URL_1)
        urlList.add(m.com.atomy.activity.DevActivity.Companion.DEV_SETTING_URL_2)
        ...
        if (null == url || url.equals("", ignoreCase = true)) {
            url = m.com.atomy.activity.DevActivity.Companion.DEV_SETTING_URL_1
        }
